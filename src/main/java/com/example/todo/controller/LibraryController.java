...
public class LibraryController {
	...
	public String exhibit(@Validated @ModelAttribute BookAddRequest bookRequest, BindingResult bindingResult, Model model, HttpSession session,@RequestParam("apiUrl") String apiUrl) {
